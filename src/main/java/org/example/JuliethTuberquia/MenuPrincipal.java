        ...
        while (true){
            ...
            try {
               if (MenuPrincipal == 1){
                   ...
                   System.out.print("Digita el ID del plato: ");
                   keyentry.nextLine();
                   diccionario.put("ID", keyentry.nextInt());

                   System.out.print("Digita el nombre del plato: ");
                   keyentry.nextLine();
                   diccionario.put("Nombre", keyentry.nextLine());

                   System.out.print("Digita los ingredientes: ");
                   keyentry.nextLine();
                   diccionario.put("Ingredientes", keyentry.nextLine());

                   System.out.print("Digita el precio del plato: ");
                   keyentry.nextLine();
                   diccionario.put("Precio", keyentry.nextFloat());
                   platos.add(diccionario);
                   System.out.println(diccionario);
                   System.out.println("Oprime enter para ver el resultado");
                   break;
